...
import { COMERCIOS, catId, tagIds } from "./datos-fase1.mjs";
...
const outPath = path.join(DATOS_PRUEBA_DIR, "scripts", "resumen-productos-fase1.json");
