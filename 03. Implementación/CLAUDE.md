...
- **Email:** SMTP real vía Spring Mail (proveedor exacto pendiente de confirmar — ver sección 9).
...
Secuencia completa definida en `GUIA-IMPLEMENTACION-MVP-BAJONEA.md`. Estado actual: **Fase 9 cerrada, siguiente: Fase 10.**
...
| 10 | Email real (SMTP) para verificación de cuenta | ⬜ pendiente |
| 11 | Cloudinary: subida firmada de imágenes de producto | ⬜ pendiente |
| 12 | Notificaciones in-app (polling) | ⬜ pendiente |
...
- **Proveedor SMTP definitivo** para el envío de email de verificación (Fase 10). La guía recomienda Brevo (plan gratuito, 300 emails/día) como opción por defecto, con DonWeb como alternativa a verificar según el plan de hosting contratado. No bloquea el resto del desarrollo — se puede avanzar con Brevo en modo sandbox mientras se confirma. Con la Fase 7 ahora incluyendo recuperación y reactivación de cuenta por email, el proveedor SMTP pasa a ser bloqueante antes de poder probar esos 2 flujos end-to-end (no solo la verificación de cuenta).
